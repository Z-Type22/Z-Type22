## Я backend-разработчик, специализирующийся на серверной части веб-приложений.

Основной фокус:
- **Backend**: Python, Django, FastAPI, aiohttp
- **Есть также опыт во Frontend**: React.js, Vue.js
---
...
Рабочие проекты хранятся в приватных репозиториях.

Публичные и pet-проекты доступны в закрепленных репозиториях для просмотра и изучения.
